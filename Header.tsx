...
import { ChevronLeft, Volume2, VolumeX, Sliders } from 'lucide-react';
      ...
      <div className="flex items-center justify-end space-x-1.5">
        {onOpenDashboard && (
          <button
            ...
            title="Open Media & Setup Studio"
            className="p-1 text-white/90 hover:text-white transition-opacity bg-black/20 hover:bg-black/30 rounded-lg"
          >
